...
class ActiveLearner(object):
    ...
    def __init__(self, **kwargs):
        ...
        # Create dictionary to store scores for every estimator
        self.scores = defaultdict(list)


    def load_data(self, X=None, y=None, data=None):
    ...
    def fit(self, **kwargs):
        X_unlab, X_lab, y_unlab, y_lab, X_test, y_test = self.load_data(**kwargs)
        ...
        for _ in range(self.n_queries):
            for alg_name, alg_class in self.algorithms.items():
                ...
                self.scores[alg_name] \
                .append(alg_class.estimator.score(X_test, y_test))
